...
#                     soup = BeautifulSoup(response.text, 'html.parser')
#                     npc_object = {
#                     "Items sold": parse_functions.get_npc_items_drop(soup),
#                 }
#                     conn = sqlite3.connect(config.database)
#                     c = conn.cursor()
...
#                         print('NPC not found, aborting parse for now...')
#                         return
#                     for item_name in npc_object['Items']:
#                         item_id = None
...
#                                 item_id = new_item_result[0]
#                         if item_id:
#                             c.execute("""INSERT INTO npc_sold (zone_id, npc_id) VALUES (?, ?)""", (item_id, npc_id))
#                     conn.commit()
#                     conn.close()
